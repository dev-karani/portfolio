                ...
                <div className=" flex flex-col min-h-[calc(95vh-var(--navbar-height))] " >
                     <div className="flex-1  flex flex-col "> 
                            ...
                            <div className="flex gap-32">
                                ...
                                <Text className="w-80">I love breaking down complex concepts into visual analogies and interactive stories—so be sure to check out my guides and labs in Legends.</Text>
                            </div>
                    </div>
                </div>
            </Container>
