                     ...
                     <div className="flex-1  flex flex-col "> 
                            <div className=" flex-1 grid grid-cols-12 gap-4 ">
                                <div className="col-start-1 col-span-6 mt-8">
                                    ...
                                    <Button to="/legend" className="ml-2.5 bg-blue-500  hover:bg-blue-100 text-white">View Projects</Button>
                            ...
                            <div className="flex gap-32">
                                ...
                                <Text className="w-88">I love breaking down complex concepts into visual analogies and interactive stories—so be sure to check out my guides and labs in Legends.</Text>
                            </div>
                    </div>
                </div>
            </Container>
